...
<section class="form-section">
    ...
    <div class="form-grid">
        ...
        <div class="full"><x-admin.media-library-select name="library_media_id" label="Choose section image from Image Gallery" :current-path="$section?->image_path" /></div>
        <div class="full"><x-admin.image-upload name="image" label="Or upload a new section image" :current="$section?->image_url" help="A new upload is automatically added to Image Gallery." /></div>
    </div>
</section>
