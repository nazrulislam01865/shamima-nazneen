...
@section('content')
<x-admin.page-header title="Add work" description="Create a work entry with optional production year, rich popup details, optional external links, and home-page visibility." />
