...
<body>
    <main class="error-card" role="main">
        <span class="code"><?php echo e($statusCode); ?></span>
        <h1><?php echo e($title); ?></h1>
        <p><?php echo e($message); ?></p>
        <a class="btn" href="<?php echo e(url('/')); ?>">Go to homepage</a>
    </main>
</body>
</html>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/shamima-nazneen/resources/views/errors/minimal.blade.php ENDPATH**/ ?>